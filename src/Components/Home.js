...
//     // Function for setting the selected item in local storage
//     function setID(id, name, age, dateOfBirth, designation, experience, expectedSalary) {
...
//                             />
//                             <InputGroup.Text><i class='bx bx-search'></i></InputGroup.Text> {/* Add the search icon */}
//                         </InputGroup>

//                     </Form>
//                     <Link to='/create'>
//                         <Button variant="success" size="lg"><i class='bx bx-plus'></i> Add</Button>
//                     </Link>
//                 </div>
